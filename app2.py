    ...
    while cap.isOpened():
        ...
        for result in resultsTracker:
            ...
            cvzone.putTextRect(img, f' {int(id)}', (max(0,x1), max(35,y1)),
                               scale=1, thickness=1, colorR=(0, 0, 0))
            ...
            if limits[0] < cx < limits[2] and limits[1] - 15 < cy < limits[1] + 15:
                if totalCount.count(id) == 0:
                    ...
                    #elif currentClass == "traffic light":
                        #color = (255, 0, 255)  # Magenta for persons
                    if currentClass!='traffic light'or 'person':  
        ...
        filtered_vehicle_counts = {k: v for k, v in vehicle_counts.items() if k != "traffic light" or "person"}
